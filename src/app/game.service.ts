...
this.initPlayers();
  ...
  figureBotMove(){//prioritize by checking block that is completing
  ...
  getCompletingSet(){
    ...
    {return 2;}
    else if(block1.free==false&&block2.free==true&&block3.free==true&&(block1.value=="cross"&&block1.value==block2.value))
    {return 3;}
    else if(block1.free==false&&block7.free==true&&block4.free==false&&(block1.value=="cross"&&block1.value==block4.value))
    {return 7;}
    ...
    {return 5;}
    else if(block1.free==false&&block9.free==true&&block5.free==false&&(block1.value=="cross"&&block1.value==block5.value))
    {return 9;}
    //forblock 2
    else if(block2.free==false&&block1.free==true&&block3.free==false&&(block2.value=="cross"&&block2.value==block3.value))
    {return 1;}
    else if(block2.free==false&&block5.free==true&&block8.free==false&&(block2.value=="cross"&&block2.value==block8.value))
    {return 5;}
  ...
  blockEnemyAttemptCompleteSet(){
    ...
    {return 2;}
    else if(block1.free==false&&block2.free==true&&block3.free==true&&(block1.value==block2.value))
    {return 3;}
    else if(block1.free==false&&block7.free==true&&block4.free==false&&(block1.value==block4.value))
    {return 7;}
    ...
    {return 5;}
    else if(block1.free==false&&block9.free==true&&block5.free==false&&(block1.value==block5.value))
    {return 9;}
    //forblock 2
    else if(block2.free==false&&block1.free==true&&block3.free==false&&(block2.value==block3.value))
    {return 1;}
    else if(block2.free==false&&block5.free==true&&block8.free==false&&(block2.value==block8.value))
    {return 5;}
